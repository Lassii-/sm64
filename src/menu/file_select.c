...
static unsigned char textReturn[][8] = {
    { TEXT_RETURN }, { TEXT_RETURN_FR }, { TEXT_RETURN_DE }, { TEXT_RETURN_FI }
};
#endif
...
static unsigned char textViewScore[][12] = {
    { TEXT_CHECK_SCORE }, { TEXT_CHECK_SCORE_FR }, { TEXT_CHECK_SCORE_DE }, { TEXT_CHECK_SCORE_FI }
};
#endif
...
static unsigned char textCopyFileButton[][15] = {
    { TEXT_COPY_FILE }, { TEXT_COPY_FILE_FR }, { TEXT_COPY_FILE_DE }, { TEXT_COPY_FILE_FI }
};
#endif
...
static unsigned char textEraseFileButton[][16] = {
    { TEXT_ERASE_FILE }, { TEXT_ERASE_FILE_FR }, { TEXT_ERASE_FILE_DE }, { TEXT_ERASE_FILE_FI }
};
#endif
...
static unsigned char textSelectFile[][17] = {
    { TEXT_SELECT_FILE }, { TEXT_SELECT_FILE_FR }, { TEXT_SELECT_FILE_DE }, { TEXT_SELECT_FILE_FI }
};
#endif
...
static unsigned char textScore[][9] = {
    { TEXT_SCORE }, { TEXT_SCORE_FR }, { TEXT_SCORE_DE }, { TEXT_SCORE_FI }
};
#endif
...
static unsigned char textCopy[][9] = {
    { TEXT_COPY }, { TEXT_COPY_FR }, { TEXT_COPY_DE }, { TEXT_COPY_FI }
};
#endif
...
static unsigned char textErase[][8] = {
    { TEXT_ERASE }, { TEXT_ERASE_FR }, { TEXT_ERASE_DE }, { TEXT_ERASE_FI }
};
#endif

#ifdef VERSION_EU
static unsigned char textOption[][10] = {
    { TEXT_OPTION }, { TEXT_OPTION_FR }, { TEXT_OPTION_DE }, { TEXT_OPTION_FI }
};
#endif
...
static unsigned char textCheckFile[][18] = {
    { TEXT_CHECK_FILE }, { TEXT_CHECK_FILE_FR }, { TEXT_CHECK_FILE_DE }, { TEXT_CHECK_FILE_FI }
};
#endif
...
static unsigned char textCopyCompleted[][18] = { { TEXT_COPYING_COMPLETED },
                                                 ...
                                                 { TEXT_COPYING_COMPLETED_FI } };
#endif

#ifndef VERSION_EU
static unsigned char textSavedDataExists[] = { TEXT_SAVED_DATA_EXISTS };
#else
static unsigned char textSavedDataExists[][24] = { { TEXT_SAVED_DATA_EXISTS },
                                                   { TEXT_SAVED_DATA_EXISTS_FR },
                                                   { TEXT_SAVED_DATA_EXISTS_DE },
                                                   { TEXT_SAVED_DATA_EXISTS_FI } };
#endif

#ifndef VERSION_EU
static unsigned char textNoFileToCopyFrom[] = { TEXT_NO_FILE_TO_COPY_FROM };
#else
static unsigned char textNoFileToCopyFrom[][22] = { { TEXT_NO_FILE_TO_COPY_FROM },
                                                    { TEXT_NO_FILE_TO_COPY_FROM_FR },
                                                    { TEXT_NO_FILE_TO_COPY_FROM_DE },
                                                    { TEXT_NO_FILE_TO_COPY_FROM_FI } };
#endif

#ifndef VERSION_EU
static unsigned char textYes[] = { TEXT_YES };
#else
static unsigned char textYes[][6] = { { TEXT_YES }, { TEXT_YES_FR }, { TEXT_YES_DE }, { TEXT_YES_FI } };
#endif

#ifndef VERSION_EU
static unsigned char textNo[] = { TEXT_NO };
#else
static unsigned char textNo[][5] = { { TEXT_NO }, { TEXT_NO_FR }, { TEXT_NO_DE }, { TEXT_NO_FI } };
#endif

#ifdef VERSION_EU
// In EU, Erase File and Sound Select strings are outside it's print string function
static unsigned char textEraseFile[][19] = { { TEXT_ERASE_FILE_BUTTON },
                                             { TEXT_ERASE_FILE_BUTTON_FR },
                                             { TEXT_ERASE_FILE_BUTTON_DE },
                                             { TEXT_ERASE_FILE_BUTTON_FI } };
static unsigned char textSure[][8] = {
    { TEXT_SURE }, { TEXT_SURE_FR }, { TEXT_SURE_DE }, { TEXT_SURE_FI }
};
static unsigned char textMarioAJustErased[][20] = { { TEXT_FILE_MARIO_A_JUST_ERASED },
                                                    ...
                                                    { TEXT_FILE_MARIO_A_JUST_ERASED_FI } };

static unsigned char textSoundSelect[][13] = {
    { TEXT_SOUND_SELECT }, { TEXT_SOUND_SELECT_FR }, { TEXT_SOUND_SELECT_DE }, { TEXT_SOUND_SELECT_FI }
};

static unsigned char textLanguageSelect[][17] = { { TEXT_LANGUAGE_SELECT },
                                                  { TEXT_LANGUAGE_SELECT_FR },
                                                  { TEXT_LANGUAGE_SELECT_DE },
                                                  { TEXT_LANGUAGE_SELECT_FI } };

static unsigned char textSoundModes[][13] = {
    { TEXT_STEREO },     { TEXT_MONO },       { TEXT_HEADSET },   { TEXT_STEREO_FR },
    { TEXT_MONO_FR },    { TEXT_HEADSET_FR }, { TEXT_STEREO_DE }, { TEXT_MONO_DE },
    { TEXT_HEADSET_DE }, { TEXT_STEREO_FI },  { TEXT_MONO_FI },   { TEXT_HEADSET_FI }
};

static unsigned char textLanguage[][9] = {
    { TEXT_ENGLISH }, { TEXT_FRENCH }, { TEXT_GERMAN }, { TEXT_FINNISH }
};

static unsigned char textMario[] = { TEXT_MARIO };
static unsigned char textHiScore[][16] = {
    { TEXT_HI_SCORE }, { TEXT_HI_SCORE_FR }, { TEXT_HI_SCORE_DE }, { TEXT_HI_SCORE_FI }
};
static unsigned char textMyScore[][10] = {
    { TEXT_MY_SCORE }, { TEXT_MY_SCORE_FR }, { TEXT_MY_SCORE_DE }, { TEXT_MY_SCORE_FI }
};

static unsigned char textNew[][5] = { { TEXT_NEW }, { TEXT_NEW_FR }, { TEXT_NEW_DE }, { TEXT_NEW_FI } };
static unsigned char starIcon[] = { GLYPH_STAR, GLYPH_SPACE };
static unsigned char xIcon[] = { GLYPH_MULTIPLY, GLYPH_SPACE };
#endif
...
void render_sound_mode_menu_buttons(struct Object *soundModeButton) {
    ...
    sMainMenuButtons[MENU_BUTTON_LANGUAGE_ENGLISH] = spawn_object_rel_with_rot(
        soundModeButton, MODEL_MAIN_MENU_GENERIC_BUTTON, bhvMenuButton, 833, -111, -100, 0, -0x8000, 0);
    ...
    sMainMenuButtons[MENU_BUTTON_LANGUAGE_FRENCH] = spawn_object_rel_with_rot(
        soundModeButton, MODEL_MAIN_MENU_GENERIC_BUTTON, bhvMenuButton, 333, -111, -100, 0, -0x8000, 0);
    ...
    sMainMenuButtons[MENU_BUTTON_LANGUAGE_GERMAN] =
        spawn_object_rel_with_rot(soundModeButton, MODEL_MAIN_MENU_GENERIC_BUTTON, bhvMenuButton, -233,
                                  -111, -100, 0, -0x8000, 0);
    sMainMenuButtons[MENU_BUTTON_LANGUAGE_GERMAN]->oMenuButtonScale = 0.11111111f;
    // Finnish option button
    sMainMenuButtons[MENU_BUTTON_LANGUAGE_FINNISH] =
        spawn_object_rel_with_rot(soundModeButton, MODEL_MAIN_MENU_GENERIC_BUTTON, bhvMenuButton, -833,
                                  -111, -100, 0, -0x8000, 0);
    sMainMenuButtons[MENU_BUTTON_LANGUAGE_FINNISH]->oMenuButtonScale = 0.11111111f;
        ...
        for (buttonID = MENU_BUTTON_OPTION_MIN; buttonID < MENU_BUTTON_OPTION_MAX; buttonID++) {
            ...
            if (check_clicked_button(buttonX, buttonY, 22.0f) == TRUE) {
                ...
                if (buttonID == MENU_BUTTON_LANGUAGE_ENGLISH || buttonID == MENU_BUTTON_LANGUAGE_FRENCH
                    ...
                    || buttonID == MENU_BUTTON_LANGUAGE_FINNISH) {
                    if (soundModeButton->oMenuButtonActionPhase == SOUND_MODE_PHASE_MAIN) {
                        play_sound(SOUND_MENU_CLICK_FILE_SELECT, gDefaultSoundArgs);
                        sMainMenuButtons[buttonID]->oMenuButtonState = MENU_BUTTON_STATE_ZOOM_IN_OUT;
...
void print_sound_mode_menu_strings(void) {
    ...
    for (mode = 0, textX = 55; mode < 4; textX += 70, mode++) {
...
void print_save_file_scores(s8 fileIndex) {
    ...
    switch (sLanguageMode) {
        ...
        case LANGUAGE_FINNISH:
            levelNameTable = segmented_to_virtual(eu_course_strings_fi_table);
            break;
    }
#endif
